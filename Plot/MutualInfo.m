...
print(gcf,'-dpng','MutualInfo.png','-r600');
...
for gg=length(gs):-1:1
    ...
    plot(subtab.nc,subtab.IShannon,'.-','Color',gmap(gg,:),'DisplayName',['g=10^{' num2str(gs(gg)) '}']);
end
[lb,licons,lplots,ltxt]= legend('show');
lb.Box = 'Off';
lb.Position = [0.72        0.43       0.1      0.10082];
...
ylim([0,2]);
% text(10^2.1,2.2,'(b)');
print(gcf,'-dpng','MutInfo_lognc.png','-r600');